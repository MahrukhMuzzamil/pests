...
class DistanceEntryScreen extends StatelessWidget {
  const DistanceEntryScreen({super.key});
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  // Bottom field to select distance
                  Obx(
                    () => buildTextField(
                      isReadOnly: true,
                      controller: TextEditingController(
                          text: controller.selectedDistance.value),
                      onTap: () => controller.showDistancePicker(
                          context, controller, controller.distances),
                  ...
                  () => CustomButton(
                    ...
                    onPressed: () => {
                      if (controller.location.value.isNotEmpty &&
                          controller.selectedDistance.value.isNotEmpty)
                        {controller.saveLocation('miles')}
                      else
                        {
