...
class ClientSettingTile extends StatefulWidget {
  final String title;
  ...
  @override
  State<ClientSettingTile> createState() => _SettingTileState();
}

class _SettingTileState extends State<ClientSettingTile> {
  bool isOn = false;
